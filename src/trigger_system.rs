...
impl<'a> System<'a> for TriggerSystem {
    ...
    fn run(&mut self, data : Self::SystemData) {
        let (map, mut entity_moved, position, entry_trigger, mut hidden, names, entities, mut log, inflicts_damage, mut particle_builder, mut inflict_damage, single_activation) = data;
                ...
                if entity != *entity_id { // Do not bother to check yourself for being a trap!
                    ...
                    match maybe_trigger {
                        ...
                        Some(_trigger) => {
                            ...
                            // If the trap does damage, then DO IT!
                            ...
                            // If it's a single-action trigger, it needs to be remove
