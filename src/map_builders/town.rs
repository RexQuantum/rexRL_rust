...
impl TownBuilder {
    ...
    fn build_pub(&mut self,
        ...
        rng: &mut rltk::RandomNumberGenerator)
    {
        // Place the player. We'll start here.
        build_data.starting_position = Some(Position{
        ...
        // Place other items
        let mut to_place : Vec<&str> = vec!["Barkeep", "Shady Fence", "Patron", "Patron",
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Priest Of The Black Stone", "Parishoner Of The Black Stone", "Parishoner Of The Black Stone", "Chair", "Chair", "Candle", "Candle"];
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Anvil", "Water Trough", "Weapon Rack", "Armor Stand"];
        self.random_building_spawn(building, build_data, rng, &mut to_place, 0);
    }
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Cabinet", "Table", "Loom", "Hide Rack"];
        self.random_building_spawn(building, build_data, rng, &mut to_place, 0);
    }
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Chemistry Set", "Dead Thing", "Chair", "Table"];
        self.random_building_spawn(building, build_data, rng, &mut to_place, 0);
    }
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Bed", "Cabinet", "Chair", "Table"];
        self.random_building_spawn(building, build_data, rng, &mut to_place, 0);
    }
    ...
    {
        // Place items
        let mut to_place : Vec<&str> = vec!["Bed", "Chair", "Table"];
        self.random_building_spawn(building, build_data, rng, &mut to_place, 0);
    }
